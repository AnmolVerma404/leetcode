...
<pre style="position: relative;"><strong>Input:</strong> n = 3, restrictions = [[0,1]], requests = [[0,2],[2,1]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, restrictions = [[0,1]], requests = [[1,2],[0,2]]
<strong>Output:</strong> [true,false]
<strong>Explanation:
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, restrictions = [[0,1],[1,2],[2,3]], requests = [[0,4],[1,2],[3,1],[3,4]]
